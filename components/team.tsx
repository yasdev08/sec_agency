    ...
    <section className="py-20 bg-bg">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            { name: 'Mehdi B', role: 'Chief Security Officer', image: '/assets/prof_icon.png' },
            { name: 'Manel H', role: 'Operations Manager', image: '/assets/prof_icon.png' },
            { name: 'Houari', role: 'Head of Technology', image: '/assets/prof_icon.png' },
          ].map((member, index) => (
            <motion.div
              key={index}
        ...
        <div className="text-center mt-12">
          <Link href="/about" className="bg-logcol2 text-white px-8 py-3 rounded-full font-semibold text-lg inline-block hover:bg-red-700 transition-colors">
          À propos de nous
          </Link>
        </div>
      </div>
